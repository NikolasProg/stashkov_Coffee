...
$(document).ready(function () {
    let tg = window.Telegram.WebApp; // Используем Telegram.WebApp для объекта tg
    let order = document.getElementById("order"); // Получаем элемент с id "order"
...
// Предположим, что у вас есть объект tg для работы с Telegram API
// Предположим, что tg.expand() нужно вызывать для расширения
